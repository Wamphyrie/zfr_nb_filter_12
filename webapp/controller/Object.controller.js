...
sap.ui.define([
		...
		"phoenix/zfr_nb_filter_12/model/formatter"
	], function (
		BaseController,
		JSONModel,
		History,
		...
		return BaseController.extend("phoenix.zfr_nb_filter_12.controller.Object", {
			...
			_onBindingChange : function () {
				...
				this.addHistoryEntry({
					...
					intent: "#FilterOperatoronaTable-display&/WorkerSet/" + sObjectId
				});
