sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("phoenix/zfr_nb_filter_12/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#FilterOperatoronaTable-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#FilterOperatoronaTable-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("phoenix.zfr_nb_filter_12.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["phoenix/zfr_nb_filter_12/localService/mockserver"], function (mockserver) {
